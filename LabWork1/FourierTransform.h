...
public:
    ...
    QVector<complex<double>> BackwardDiscreteTransform(QVector<double> sample);
    QVector<complex<double>> BackwardDiscreteTransform(QVector<complex<double>> sample);
    ...
    QVector<complex<double>> BackwardFastTransform(QVector<double> sample);
    QVector<complex<double>> BackwardFastTransform(QVector<complex<double>> sample);
private:
